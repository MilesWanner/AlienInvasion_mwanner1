"""
Program: Alien Invasion - Track 1 (Scoreboard Module)
Author: Miles Wanner
Purpose: Display the score, high score, level, and remaining ships.
...
class Scoreboard:
    """Display scoring and gameplay information."""

    def __init__(self, ai_game: "AlienInvasion") -> None:
        """Initialize the scoreboard and prepare its images."""
    ...
    def prep_ships(self) -> None:
        """Create ship icons showing the remaining lives."""
        self.ships = Group()
    ...
    def show_score(self) -> None:
        """Draw score information and remaining ships."""
        self.screen.blit(
            self.score_image,
            self.score_rect,
        )
    ...
    def check_high_score(self) -> None:
        """Update the high score when a new record is reached."""
